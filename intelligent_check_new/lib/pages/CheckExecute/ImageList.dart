...
class ImageList extends StatefulWidget{
  ...
  ImageList(this.imageList,{this.limitCount});
            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: (){
                      if(this.widget.limitCount!=null
                          && this.widget.limitCount>0
                          &&_imageList.length==this.widget.limitCount){
                        HiddenDangerFound.popUpMsg("最多只能拍摄${this.widget.limitCount}张图片！");
                        return ;
                      }
