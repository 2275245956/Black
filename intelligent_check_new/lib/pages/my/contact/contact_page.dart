...
var  companyName;
  ...
  getData() async{
    ...
    await   SharedPreferences.getInstance().then((sp) {
      companyName=(sp.getString("sel_com")==null || sp.getString("sel_com")=="")?"--":json.decode(sp.getString("sel_com"))["companyName"];
             ...
             child: Text(bean.name,style: TextStyle(color: Colors.black),),
              ...
              onTap:  (){
                Navigator.push(context, MaterialPageRoute(builder: (context){
                  ChildInfo chInfo=new ChildInfo.fromParams(
                    name: bean.name,
                    departmentName: bean.departmentName??"--",
                    telephone:bean.telephone??json.decode(bean.objects)["telephone"]??"--",
                    email: bean.email??json.decode(bean.objects)["email"]??"--"
                  );


                  return Contactinfo(info:chInfo,);
                }));
              }
          ),
        ],
