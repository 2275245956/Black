...
import 'package:intelligent_check_new/pages/Activity/activility_steps_siteConfirming.dart';
import 'package:intelligent_check_new/pages/hidedanger_manage/hidden_danger_found.dart';
import 'package:intelligent_check_new/services/Activility_services.dart';
import 'package:intelligent_check_new/tools/GetConfig.dart';
import 'package:modal_progress_hud/modal_progress_hud.dart';

class ActivilityStepsSiteConfirm extends StatefulWidget {
  final ActivilityModel _activility;
  final bool readonly;
  ActivilityStepsSiteConfirm(this._activility,this.readonly);
...
class _ActivilityStepsRun extends State<ActivilityStepsSiteConfirm> {
  String strRouts = "";
  String strClassify = "";
          ...
          setState(() {
            if (response.success) {
              ...
              if (response.message != null) {
                HiddenDangerFound.popUpMsg(response.message ??"操作失败,确认信息填写完善！");
              }
            }
            isAnimating = false;
            canOperate = true;
                                ...
                                child: GestureDetector(
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                        child: (!this.widget.readonly)?Row(
                                          mainAxisAlignment:
                                  ...
                                  onTap: () {
                                    Navigator.push(context,
                                        MaterialPageRoute(
                                            builder: (context) {
                                              return ActivilityStepsSiteConfirming(
                                                  this.widget._activility,s,this.widget.readonly);
                                            }));
                                  },
                                ));
                          }).toList(),
