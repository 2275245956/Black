...
class ActivilityStepsEnvConfirming extends StatefulWidget {
  final ActivilityModel _activility;
  final StepsModel steps;
  final bool readonly;

  ActivilityStepsEnvConfirming(this._activility, this.steps, this.readonly);

  @override
  State<StatefulWidget> createState() {
    return _ActivilityStepsEnvConfirming();
  }
}

class _ActivilityStepsEnvConfirming
    extends State<ActivilityStepsEnvConfirming> {
  String strRouts = "";
  String strClassify = "";
        ...
        for (TaskFactorModel twr in factorsList) {
          if (twr.measuresList != null && twr.measuresList.length > 0) {
            for (MeasuresModel mm in twr.measuresList) {
              ...
              mm.showRemark =
                  mm.envChangeIdea != "" && mm.envChangeIdea != null;
                                                                      ...
                                                                      ? Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: <Widget>[
                                                                              ...
                                                                              Expanded(
                                                                                child: Text("${m.envEnsureStatus == 1 ? '已确认' : (m.envEnsureStatus == 2 ? '现场整改' : '')}", style: TextStyle(color: Colors.green), textAlign: TextAlign.right),
                                                                              ),
                                                                            ],
                                                                          ))
                                                                      : Row(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                child: Wrap(
                                                                                    ...
                                                                                    //沿主轴方向居中
                                                                                    children: m.envImgs != "" && m.envImgs != null
                                                                                        ? m.envImgs.split(",").map((f) {
                                                                                            return Column(
                                                                                              ...
                                                                                              children: <Widget>[
                                                                                                Container(
                                                                                                  ...
                                                                                                  decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.all(Radius.circular(20.0)), image: DecorationImage(image: NetworkImage(f), fit: BoxFit.cover)),
                                                                                                ),
                                                                                              ],
                                                                                            );
                                                                                          }).toList()
                                                                              ...
                                                                              onTap: () {
                                                                                Navigator.push(context, MaterialPageRoute(builder: (context) {
                                                                                  return PhotoViewPage(m.envImgs.split(","));
                                                                                }));
                                                                              },
                                                                            ),
                                                                          ),
                                                                          ...
                                                                          Navigator.push(
                                                                            ...
                                                                            if (v !=
                                                                              ...
                                                                              setState(() {
                                                                                ...
                                                                                if (null != m.imageList && m.imageList.length > 0) {
                                                                                  m.imageList.forEach((f) {
                                                                                    fileData.add(Attachment.fromParams(file: f));
                                                                                  });
                                                                                  //保存图片
                                                                                  _upDateImg(m, fileData);
                                                                                }
                                                                              });
                                                                            }
                                                                          });
