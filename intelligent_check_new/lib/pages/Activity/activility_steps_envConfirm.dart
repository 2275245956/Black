...
class ActivilityStepsEnvConfirm extends StatefulWidget {
  final ActivilityModel _activility;
  final bool readonly;
  ActivilityStepsEnvConfirm(this._activility,this.readonly);
...
class _ActivilityStepsRun extends State<ActivilityStepsEnvConfirm> {
  String strRouts = "";
  String strClassify = "";
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      child:  Scaffold(
                                ...
                                child: GestureDetector(
                                  ...
                                  onTap: () {
                                    Navigator.push(context,
                                        MaterialPageRoute(
                                            builder: (context) {
                                              return ActivilityStepsEnvConfirming(
        ...
        persistentFooterButtons:  (!this.widget.readonly)?<Widget>[
          Container(
