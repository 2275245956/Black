...
import 'package:intelligent_check_new/pages/Activity/activility_search_result.dart';
import 'package:intelligent_check_new/tools/GetConfig.dart';
import 'package:intelligent_check_new/widget/search/hotSug.dart';
import 'package:shared_preferences/shared_preferences.dart';

class ActivilitySearchPage extends StatefulWidget{
  ActivilitySearchPage();

  @override
  State<StatefulWidget> createState() => new _ActivilitySearch();
}

class _ActivilitySearch extends State<ActivilitySearchPage>{
...
//      ),
    ...
    if(keyword != null && keyword.isNotEmpty){
      ...
      Navigator.push(context,
          new MaterialPageRoute(builder: (context) {
            return new ActivilitySearchSearchResultPage(keyword);
          })
      );
    }
  }
  ...
  searchByHistory(String text){
    ...
    Navigator.push(context,
        new MaterialPageRoute(builder: (context) {
          return new ActivilitySearchSearchResultPage(text);
        })
    );
  }
