...
import 'package:intelligent_check_new/pages/Activity/activility_teamViewSteps.dart';
                                    ...
                                    child: GestureDetector(
                                      child: Row(
                                        children: <Widget>[
                                          Expanded(
                                            child: Text(
                                              ("${steps.indexOf(s) + 1}.  ${s.taskworkContentName}"),
                                              style: TextStyle(
                                                fontWeight: FontWeight.w500,
                                                fontSize: 16,
                                              ),
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                            ...
                                            new MaterialPageRoute(
                                                builder: (context) =>
                                                    ActivilityTeamViewSteps(
                                                        this.widget._activility,
                                                        s)));
                                      },
                                    ));
                              }).toList(),
