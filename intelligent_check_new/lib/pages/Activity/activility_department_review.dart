...
class ActivilityDepartmentReview extends StatefulWidget {
  final int id;

  ActivilityDepartmentReview(this.id);

  @override
  _ActivilityDepartmentReview createState() =>
      new _ActivilityDepartmentReview();
}

class _ActivilityDepartmentReview extends State<ActivilityDepartmentReview> {
  bool isAnimating = false;
  bool canOperate = true;
  String theme = "";

  int needComLeaderView = 0;
                ...
                children: <Widget>[
                  ...
                  Column(
                    children: <Widget>[
                      RadioListTile(
                        value: 1,
                        groupValue: needComLeaderView,
                        title:Text("是") ,
                        onChanged: (val){
                          state(() {
                            needComLeaderView=val;
                          });
                        },
                      ),
                      RadioListTile(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: FlatButton(child: Text("确定",style: TextStyle(fontSize: 16,color: Colors.white),),onPressed: (){
                          if (canOperate) {
                            var flowJosn={
                              "companyVerifyState":needComLeaderView
                            };
                            executeFlow(2, this._suggestion.text, flowJosn);
                          } else {
