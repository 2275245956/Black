...
class ActivilitySiteConfirm extends StatefulWidget {
  final int id;
  ActivilitySiteConfirm(this.id);

  @override
  _ActivilitySiteConfirm createState() => new _ActivilitySiteConfirm();
}

class _ActivilitySiteConfirm extends State<ActivilitySiteConfirm> {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: new MaterialButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return ActivilityStepsSiteConfirm(this.initData,false);
                    }));
