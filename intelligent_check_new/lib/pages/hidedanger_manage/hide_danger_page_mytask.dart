...
class HiderManageMyTaskPage extends StatefulWidget {

  final TaskContentInput taskContentInput;
//  final num userId;
  HiderManageMyTaskPage(this.taskContentInput);
...
class _HiderManageMyTaskPageState extends State<HiderManageMyTaskPage>
...
//      '{"processed": 0, "total": 0, "cancelled": 0, "completed": 0, "timeout": 0}');
  ...
  @override
  void didUpdateWidget(HiderManageMyTaskPage oldWidget) {
  ...
  getData() async {
    await SharedPreferences.getInstance().then((sp) {
      ...
      getAllTaskList(this.widget.taskContentInput,userId,1).then((data) {
        setState(() {
          initData = data;
        });
      });
      getChart(this.widget.taskContentInput,userId,1).then((data) {
        setState(() {
          chartResult = data;
        });
      });
    });
//    await getAllTaskList(this.widget.taskContentInput,this.widget.userId,1).then((data) {
//      setState(() {
//        initData = data;
//      });
//    });
//    await getChart(this.widget.taskContentInput,this.widget.userId,1).then((data) {
//      setState(() {
//        chartResult = data;
//      });
//    });
                ...
                child: Center(
                    child: new ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return MyBar(initData[index],()=>refreshPage(),theme);
                        })))),
        flex: 4,
      )
    ])));
