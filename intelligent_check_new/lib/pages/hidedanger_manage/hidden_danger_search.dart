...
import 'package:intelligent_check_new/pages/hidedanger_manage/danger_search_result.dart';
...
HiddenDangerSearchPage(this.isHandle);
  ...
  @override
  State<StatefulWidget> createState() => new _HiddenDangerSearchPage();
}
...
//      ),
    ...
    if(keyword != null && keyword.isNotEmpty){
      ...
      Navigator.push(context,
          new MaterialPageRoute(builder: (context) {
            return new HiddenSearchSearchResultPage(keyword,this.widget.isHandle);
          })
      );
    }
  }
  ...
  searchByHistory(String text){
    ...
    Navigator.push(context,
        new MaterialPageRoute(builder: (context) {
          return new HiddenSearchSearchResultPage(text,this.widget.isHandle);
        })
    );
  }
